...
export default function Home() {
  return (
    <main  className=' relative h-screen w-full bg-gradient-to-br from-[#2B2B33] to-[#3e3e48] m-0'>
      <div className=' flex flex-col h-screen top-0 justify-around items-center absolute left-[10%] lg:flex-row lg:top-1/3 lg:h-fit w-4/5'>
        <div className='mt-8 flex flex-col justify-center items-center lg:mt-0 lg:justify-start lg:items-start'>
          ...
          <h1 className={`italic text-[#B1B1BD] text-3xl sm:text-4xl lg:text-[2.8rem] 3xl:text-8xl mb-7 ml-1 font-medium tracking-wide ${garamond.className}`}>Full Stack Web Developer</h1>
