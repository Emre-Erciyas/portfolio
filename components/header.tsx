    ...
    <div>
      <div className='fixed w-full z-10 bg-[#2B2B33] bg-opacity-10 opacity-70'>
        ...
        <div className='hidden md:flex justify-end '>
          <button type = 'button' className={`text-[#F0F0FF] text-2xl tracking-wide hover:text-[#6f6f78] duration-[400ms] mx-4 my-2 ${garamond.className}`}>Home</button>
          <button type = 'button' className={`text-[#F0F0FF] text-2xl tracking-wide hover:text-[#6f6f78] duration-[400ms] mx-4 my-2 ${garamond.className}`}>Projects</button>
          <button type = 'button' className={`text-[#F0F0FF] text-2xl tracking-wide hover:text-[#6f6f78] duration-[400ms] mx-4 my-2 ${garamond.className}`}>About</button>
          <button type = 'button' className={`text-[#F0F0FF] text-2xl tracking-wide hover:text-[#6f6f78] duration-[400ms] mx-4 my-2 ${garamond.className}`}>Contact</button>
        </div>
      </div>
      {isMenuOpen && (
