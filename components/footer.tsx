...
export default function Footer(props: Props) {
  ...
  return (
    <footer ref={props.contactRef} className={`relative w-full bg-gradient-to-br to-[#B1B1BD] from-[#fefeff] m-0 flex flex-col justify-center ${garamond.className}`}>
      <ToastContainer
        position="top-right"
        autoClose={5000}
        hideProgressBar={false}
      ...
      <form ref = {formRef} onSubmit={handleSubmit} className={`${isVisible ? 'opacity-100': 'opacity-0'} delay-100 duration-1000 flex flex-col justify-center items-center`}>
        ...
        <div className='flex flex-col justify-center items-center'>
          <div className='w-[90vw] xs:w-80 sm:w-[25rem] 3xl:w-[40rem] flex flex-col  xs:flex-row xs:justify-between xs:items-center my-2'>
            <label className={`text-[#2B2B33] text-base sm:text-xl 3xl:text-4xl italic`}>Name: </label>
          ...
          <div className=' w-[90vw] xs:w-80 sm:w-[25rem] 3xl:w-[40rem] my-4 flex flex-col  xs:flex-row xs:justify-between xs:items-center'>
            <label className={`text-[#2B2B33] text-base sm:text-xl 3xl:text-4xl italic`}>Email: </label>
          ...
          <div className='w-[90vw] xs:w-80 sm:w-[25rem] 3xl:w-[40rem] flex flex-col  xs:flex-row xs:justify-between mt-4 mb-10 h-24'>
            <label className={`text-[#2B2B33] text-base sm:text-xl 3xl:text-4xl italic`}>Message: </label>
        ...
        <button type='submit' className={`text-[#fefeff] mb-24 mt-6 font-bold bg-[#2B2B33] py-2 px-8 rounded`}>Send</button>
      </form>
