    ...
    <div className='flex flex-col lg:flex-row justify-around items-center h-screen w-full bg-gradient-to-br from-[#2B2B33] to-[#3e3e48] m-0'>
      <article className=' m-12 flex flex-col justify-center items-center lg:items-start max-w-[80%] md:max-w-[70%] lg:max-w-[45%]'>
        ...
        <p className={`text-[#B1B1BD] text-lg md:text-xl lg:text-2xl xl:text-3xl 3xl:text-5xl p-4 break-words tracking-wide ${garamond.className}`}>
          ...
          On the front-end, I'm skilled in HTML, CSS, and JavaScript and I'm comfortable working with React and 
          Next.js. I also have decent knowledge in back-end development and worked with Java, Python, C++, Firebase and mySQL.
        </p>
