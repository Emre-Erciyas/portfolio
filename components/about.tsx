...
export default function About(props: Props) {
  ...
  return (
    <div ref={props.aboutRef} className='flex flex-col lg:flex-row justify-around items-center h-screen w-full bg-gradient-to-br from-[#2B2B33] to-[#3e3e48] m-0'>
      <article data-id = '0' ref={ref1} style={garamond.style} className= {`${areVisible[0] ? 'opacity-100' : 'opacity-0'} duration-1000 m-12 flex flex-col justify-center items-center lg:items-start max-w-[80%] md:max-w-[70%] lg:max-w-[45%]`}>
        ...
        <p className={`text-[#B1B1BD] sm:text-xl md:text-2xl xl:text-3xl 3xl:text-5xl p-1 md:p-4 3xl:p-10 break-words tracking-wide italic`}>
          I am Emre Erciyas, a <span className='italic'>Full-stack Web Developer</span>. I graduated from the Department of Computer Engineering at Bilkent University in 2022.
      ...
      <div>
        <Image data-id = '1' ref={ref2} src = {rose} alt = 'rose'  className = {`${areVisible[1] ? 'opacity-100' : 'opacity-0'} duration-1000 h-[160px] w-[102px] md:h-[200px] md:w-[140px] lg:h-[300px] lg:w-[210px] 3xl:h-[500px] 3xl:w-[350px]`} />
      </div>
    </div>
  )
}